...
export const Start5 = () => {
  ...
  return (
    <div className="h-screen w-full bg-white flex flex-col items-center p-4 md:p-6 overflow-hidden">
      ...
      {/* 메인 콘텐츠 영역 */}
      <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-4 flex-1 overflow-hidden">
        {/* 비디오 + 추가 콘텐츠 영역 */}
        <div className="flex-1 grid grid-cols-2 gap-2 overflow-hidden">
          {/* 비디오 영역 */}
          <div className="bg-gradient-to-br from-purple-100 to-blue-100 rounded-lg shadow flex items-center justify-center min-h-[180px]">
          ...
          {/* 추가 콘텐츠 카드 */}
          <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-lg shadow flex items-center justify-center min-h-[180px]">
            <p className="text-gray-400 text-xs">추가 콘텐츠</p>
          </div>
        </div>

        {/* 세션 타이머 */}
        <div className="w-full lg:w-72 bg-white border rounded-lg shadow p-4 flex flex-col items-center flex-shrink-0">
      ...
      {/* 하단 버튼 */}
      <div className="w-full max-w-6xl flex justify-end gap-2 mt-4 flex-shrink-0">
