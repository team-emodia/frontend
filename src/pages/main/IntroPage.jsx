        ...
        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full">
                {slide.items.map((item, idx) => (
                  <motion.div
                    ...
                    className="bg-white/90 rounded-2xl p-6 flex flex-col items-center shadow-lg"
                  >
              ...
              <div className="space-y-6 max-w-3xl w-full">
                {slide.items.map((item, idx) => (
                  <motion.div
                    ...
                    className="flex items-center gap-6 bg-white/80 rounded-xl p-4 shadow"
                  >
                    <img src={item.img} alt={item.title} className="w-16 h-16" />
          ...
          {slide.type === "schedule" && (
            <>
              ...
              <div className="bg-white/90 rounded-2xl p-8 max-w-lg w-full mb-12 shadow">
